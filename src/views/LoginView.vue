    ...
    <div class="w-1/2 bg-purple-700 p-12 flex items-center">
      <div class="text-white">
        <h1 class="text-4xl font-bold mb-6">
          Conecte-se ao Futuro da Comunicação
        </h1>
        <div class="space-y-6">
          <div class="flex items-start space-x-4">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Chat em Tempo Real</h3>
              <p class="text-purple-100">Comunique-se instantaneamente com sua equipe, compartilhe arquivos e mantenha todos alinhados.</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Organização Inteligente</h3>
              <p class="text-purple-100">Organize suas conversas por projetos, tópicos ou equipes. Encontre qualquer informação rapidamente.</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              <h3 class="text-xl font-semibold mb-2">Segurança Primeiro</h3>
              <p class="text-purple-100">Suas conversas são protegidas com criptografia de ponta a ponta. Sua privacidade é nossa prioridade.</p>
            </div>
          </div>
        </div>
      </div>
